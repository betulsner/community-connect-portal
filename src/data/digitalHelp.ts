...
export const digitalHelpTopics: DigitalHelpTopic[] = [
  {
    ...
    recommendedLocationId: "ladywood-health-centre",
    recommendedEventId: "digital-help-hour"
  },
  {
    id: "cv-jobs",
    ...
    relatedTags: ["digital-help"],
    recommendedLocationId: "spring-hill-library",
    recommendedEventId: "cv-help-hour"
  },
  {
    id: "benefits-council",
  ...
  },
  {
    ...
    relatedTags: ["digital-help"],
    recommendedLocationId: "spring-hill-library",
    recommendedEventId: "beginner-computer-session"
  },
  {
    id: "online-safety",
    title: "Online safety",
