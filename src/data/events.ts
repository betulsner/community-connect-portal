...
export const events: CommunityEvent[] = [
  ...
  },
  {
    ...
    helpOffered: "Friendly welcome, local signposting, and community connections.",
  ...
  {
    id: "device-support-event",
    name: "Device Support Drop-in",
    dateTime: "Saturday, 25 May, 10:00–13:00",
    location: "SIFA Fireside",
    price: "Free",
    audience: "People with slow or broken phones and laptops",
    category: "Device support",
    summary: "Get help with your device from trained volunteers.",
    helpOffered: "Phone checks, setup help, and repair advice.",
    accessibility: "Accessible building with seating.",
    locationId: "sifa-fireside",
    contact: "Walk in during event hours.",
    stampsOffered: true,
    stampsCount: 10,
    themes: ["devices", "phones", "laptops"]
  },
  {
